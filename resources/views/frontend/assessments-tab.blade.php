                ...
                <div class="user-dashboard-info-box">
                    <div class="section-title-02 mb-2 d-grid">
                        ...
                        <div class="col-12 d-block d-sm-flex">
                            @forelse ($pending as $pending_assessment)
                                <div class="col-3">
                                    <a href="{{ route('accessments.fetch',$pending_assessment->id) }}" class="btn btn-md btn-primary">{{ $pending_assessment->name }}</a>
                                </div>
                                @empty
                                No More Assessments are Pending
                            @endforelse
                        </div>  
                    </div>
                </div>

                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Permissions Module</span>
                            </h3>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    @forelse($permissions as $item)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                {!!Form::open([
                                                'method'=>'delete',
                                                'route' =>['permissions.destroy',$item->id],
                                    ...
                                    @empty
                                        <h4 class="card-title text-center flex-column">
                                            <span class="card-label fw-bolder fs-3 mb-1">Permissions Not Found</span>
                                        </h4>
                                    @endforelse
                                    </tbody>
                                    <!--end::Table body-->

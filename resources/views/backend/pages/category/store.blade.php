    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_modal_new_target_form" method="POST" class="form" action="{{ route('category.store') }}">
                    @csrf
                    <!--begin::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Enter Category Title" name="category_title" />
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="d-flex flex-stack mb-8">
                        ...
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" name="category_status" value="1" checked="checked" />

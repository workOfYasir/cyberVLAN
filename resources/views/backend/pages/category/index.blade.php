    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--end::Wrapper-->
                <!--begin::Button-->
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Create</a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
        </div>
...
<!--begin::Post-->
		...
		<div id="kt_content_container" class="container-xxl">
			<!--begin::Card-->
						...
						@include('backend.pages.category.store')
                        <!--begin::Tables Widget 13-->
                            <div class="card mb-5 mb-xl-8">
                                <!--begin::Header-->
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder fs-3 mb-1">Categories Module</span>
                                    </h3>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$item->category_name}}</a>
                                                </td>
                                                <td>
                                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{@$item->mainCategory->category_name}}</a>
                                                </td>
                                                {{-- @if ($item->status==1)
                                                    <td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-category" data-id="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#kt_modal_cat_edit_target">
                                                    ...
                                                    <a href="{{route('category.delete',$item->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                            ...
                                            @empty
                                                <h4 class="card-title text-center flex-column">
                                                    <span class="card-label fw-bolder fs-3 mb-1">Categories Not Found</span>
                                                </h4>
                                            @endforelse
                                            </tbody>
                                            <!--end::Table body-->
